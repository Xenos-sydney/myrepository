...
import { Menu, X, User, Briefcase, Brain, Mail, Lightbulb, Radio, Rocket } from "lucide-react";
...
export default function Home() {
    ...
    <main className="min-h-screen bg-black text-white scroll-smooth scroll-snap-y scroll-snap-mandatory">
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[55] bg-black/95 backdrop-blur-lg flex flex-col px-8 pt-24 pb-10 md:hidden">
          ...
          <p className="text-2xl font-bold text-white mb-10">Ryan Walker.</p>
  ...
  <h1 className="text-4xl md:text-5xl font-black leading-none uppercase">
  ...
  <div className="mt-8 flex gap-4 flex-wrap">
    <button className="bg-orange-500 hover:bg-orange-600 transition px-8 py-4 rounded-full font-semibold">
      Hire Me
    </button>
    <button className="border border-white/30 hover:border-orange-400 transition px-8 py-4 rounded-full">
      View Work
    </button>
  </div>
</motion.div>
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              window.location.href =
                `mailto:youremail@example.com?subject=Message from ${name}&body=` +
